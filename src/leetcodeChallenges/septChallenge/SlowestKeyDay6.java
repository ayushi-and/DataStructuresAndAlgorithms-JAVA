...
Note that the same key could have been pressed multiple times during the TreeDS.test, and these multiple presses of the same key may not have had the same duration.
