...
public class UnionIntersectionOfListsHashing {
    ...
    //Initialize the result list as NULL and create an empty hash table.
    //Traverse list1. For ea    ch element being visited in list1, insert the element in the hash table.
    //Traverse list2, for each element being visited in list2, look the element in the hash table.
    //If the element is present, then insert the element to the result list. If the element is not present, then ignore it.
